...
ActiveRecord::Schema.define(version: 20170730161832) do
  ...
  add_index "organizations", ["compagny_id"], name: "index_organizations_on_compagny_id", using: :btree
  ...
  add_foreign_key "organizations", "compagnies"
